[CmdletBinding()] param ( 	[Parameter(Mandatory)] 	[String] $ClassName, [Parameter(Mandatory)]

    [String] $Namespace, [Parameter()] 	[String] $PropertyName ) function extractProperty($cimProperty, $Namespace) {
